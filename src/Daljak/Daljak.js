        ...
        <div className="daljak__category">
            <div className="daljak__category--box ">
                <div className="daljak__box--category ">
                    ...
                    <div className="daljak__box--cardlist--grid" >
                        {cardlist}
                    </div>
                </div>
            </div>
...
function DaljakToday({images}) {
    const component  = images.map((imgUrl,index) => (
        <DaljakTodayComponent  key={`today${index}`} imgUrl={imgUrl} title="Et omnis aut id"  date="2021/3/30" desc="Et omnis aut id. Aut eaque est quaerat. Doloribus omnis fugit et sit ducimus expedita."  />
    ));
    return(
        <div className=" daljak__category ">
            <div className=" daljak__category--box--today ">
                <div className=" daljak__box--it ">
                    <div>
                        <span className=" daljak__box--it--title ">오늘의 <span style={{backgroundColor:"rgba(129, 106, 254, 1)"}}>인기작</span></span>
                    </div>
                       {component}
        ...
        <div className=" daljak__box--cardlist--card--today ">
            ...
            <div className=" daljak__box--cardlist--card--today--textbox ">
                <div className=" daljak__box--cardlist--card--today--text ">
                    <div className=" daljak__box--cardlist--card--today--title ">{title}
                    </div>
                    <div className=" daljak__box--cardlist--card--today--date ">{date}</div>
                </div>
     
                <span className=" daljak__box--cardlist--card--today--desc ">{desc}
                </span>
            </div>
        </div>
    )
